    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookStore.Domain.EFDbContext>
    {
        ...
        protected override void Seed(BookStore.Domain.EFDbContext context)
        {
            ...
            Author author = new Author()
            {
                ...
                Books = bookList,
                Rating = 7,
                ImageUrl = "http://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Jack_London_young.jpg/250px-Jack_London_young.jpg"
            };
            User user = new User()
            {
            ...
            Tag tag=new Tag(){ TagName=book.Title,Books=bookList};
